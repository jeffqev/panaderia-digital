...
(function ($, window, document, undefined) {
    ...
    $.extend(simpleCart.prototype, {
        ...
        _setupCart: function () {
            ...
            this.cart_ele.append("<div class='panel-heading cart-heading'><div class='total-cart-count'>Tu carrito 0 items</div><div class='spacer'></div><i class='fa fa-dollar total-cart-cost'>0</i><div></div></div>")
        ...
        _updateCartDetails: function () {
            ...
            $(this.options.totalCartCountClass).html("Tienes " + mi._totalCartCount() + " items en tu carrito");
        ...
        _displayCart: function () {
            ...
            if (cartArray.length <= 0) {
                output = "<h4>Tu carrito esta vacio</h4>";
            }
