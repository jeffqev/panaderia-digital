<?php
require '../../Controller/ingredientesController.php';


$ingredientesController = new ingredientesController();


if (isset($_POST['incantidad'])) {
    
    $error = $ingredientesController->insertaringredientes($_POST['mtid'],$_POST['recid'],$_POST['incantidad'],$_POST['incosto']);
}
...
$error = $ingredientesController->eliminaringredientes($_GET['eliminar']);
                        ...
                        <div style="width: 100%">
                            ...
                            <div class="row ml-3">
                                <div class="col-11 col-lg-4 ingresos" style="font-family: 'Roboto',sans-serif; font-weight: 300; color: #999C9E;">
                                    ...
                                    <form action="ingredientes.php" method="POST" name="formusuarios" class="form-group" >
                                        
                                        <label for="">Materia Prima</label><br>
                                        <select name="mtid" class="form-control mb-3" name="" id="mtid">
                                                <?php
                                                $vec = $ingredientesController->consultarmt();
                                        ...
                                        <select class="form-control mb-3" name="recid" id="recid">
                                                <?php
                                                $vec = $ingredientesController->consultarrec();
                                        ...
                                        <input class="form-control mt-3 mb-3" require type="number" placeholder="Cantidad Ingrediente " name="incantidad" >
                                        <input class="form-control mb-3" require type="text" placeholder="Costo" name="incosto" >
                                ...
                                <div class="col-11 col-lg-7 ver ">
                                    ...
                                    <div class="tabla">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                $vec = $ingredientesController->listaringredientes();
                                                
                                                for ($i=0; $i < count($vec) ; $i++) {                               
                                                    echo "<tr><td>".$vec[$i][0]."</td>";
                                                    echo "<td>".$ingredientesController->getmtnombreporid($vec[$i][1])."</td>";
                                                    echo "<td>".$ingredientesController->getrecnombreporid($vec[$i][2])."</td>";
                                                    echo "<td>". $vec[$i][3]."</td>";   
                                                    echo "<td>".$vec[$i][4]."</td>";
                                                    echo "<td>".$vec[$i][5]."</td>";
                                                    ...
                                                    echo '<td> <a href="ingredientes.php?eliminar='.$vec[$i][0].'" class="btn btn-outline-danger">Eliminar</a>  </td>';  
