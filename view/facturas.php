                        ...
                        <div style="width: 100%">
                            ...
                            <div class="row ">
                                    ...
                                    <div class="col-11 col-lg-4  ">
                                        <p class="letra">Crear factura</p>
                                        <a href="Components/factura.php"><img src="Assets/img/bill.png" alt="" width="200" height="200"></a>
                                    </div>
                                    <div class="col-11 col-lg-5  ">
                                        <p class="letra">Buscar facturas</p>
                                        <a href="Components/detalle.php"><img src="Assets/img/contract.png" alt="" width="200" height="200"></a>
                                    </div>
