...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-07-2019 a las 04:30:16
...
CREATE TABLE `detalle` (
  ...
  `DETPRECIOVENTA` decimal(10,0) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `factura` (
  ...
  `FACTTOTAL` decimal(10,0) DEFAULT NULL,
...
CREATE TABLE `receta` (
  ...
  `RECCOSTO` decimal(10,0) NOT NULL,
  `RECESTADO` int(11) DEFAULT NULL,
  `RECPRECIO` decimal(10,0) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
(1, 'Pan de migas', '0', 1, '0'),
(2, 'Pan cachito', '0', 1, '0'),
(3, 'Pan Integral', '0', 1, '0');
